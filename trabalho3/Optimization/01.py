...
que melhor se aproxima da função f(x)=2sin(x)+cos(−x2) no intervalo [a,b], com a=−1.07703 e b=2.49721. Para o cálculo dos coeficientes ck, use a regra dos trapézios com 256 subintervalos. Em seguida calcule g(x) para os seguintes valores de x
x1=−0.79436, x2=1.15428 e x3=1.75505.
A função g(x) é uma aproximação para a função f(x) no intervalo [−1.07703,2.49721] com erro dado por
erro=∫2.49721−1.07703[f(x)−g(x)]2dx.
